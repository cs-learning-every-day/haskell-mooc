...
allValues cond (Node a left right) = cond a && allValues cond left && allValues cond right
...
isOrdered (Node a l r) = isOrdered l && isOrdered r && allValues (< a) l && allValues (> a) r
...
set (StepL : rest) val (Node a l r) = Node a (set rest val l) r
set (StepR : rest) val (Node a l r) = Node a l (set rest val r)
